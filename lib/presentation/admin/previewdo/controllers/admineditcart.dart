...
import 'package:dpil/presentation/admin/do/admin_do.screen.dart';
import 'package:dpil/presentation/admin/previewdo/admin_previewdo.screen.dart';
import 'package:dpil/presentation/admin/previewdo/controllers/admin_previewdo.controller.dart';
...
class AdminEditCartItemsScreen extends StatelessWidget {
  final AdminPreviewdoController controller =
      Get.put(AdminPreviewdoController());
  final List<dynamic> data;
                    ...
                    if (controller.formKey.currentState!.validate()) {
                      ...
                      for (var index = 0; index < itemList.length; index++) {
                        ...
                        var unit = currentItem.length > 4
                            ? currentItem[4]?.toString() ?? ''
                            : '';
                        var perUnitPrice = double.tryParse(
