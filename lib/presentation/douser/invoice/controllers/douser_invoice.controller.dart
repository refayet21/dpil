...
//               // ),
//               pw.Row(children: [
//                 pw.Table.fromTextArray(headers: ['DO# 2801912128'], data: []),
//               ]),
//               pw.Row(children: [
//                 pw.Table.fromTextArray(
//                     headers: ['Marketing Person : ' 'Refayet Ullah Toiyob'],
//                     data: []),
//               ]),
//               pw.Row(children: [
//                 pw.Table.fromTextArray(
...
//   }
  ...
  Future<void> generateInvoicePdf(String vendorName, String date,
    ...
    try {
      ...
      final tableData = [
        ['1', 'Coffee', '7', '\$ 5', '1 %', '\$ 35', 'Good'],
        ['2', 'Tea', '5', '\$ 3', '2 %', '\$ 15', 'Excellent'],
        ['3', 'Milk', '10', '\$ 2', '3 %', '\$ 20', 'Superb'],
      ];
          ...
          build: (context) {
            return [
                    ...
                    pw.Expanded(
                      child: pw.Column(
                        children: [
                          ...
                          pw.Text('Quantity: $productQuantity'),
                        ],
                      ),
                    ),
                  ],
              ...
              pw.Row(
                ...
                children: [
                  pw.Text(
                    'IN WORDS BDT: Forty-Eight Thousand Six Hundred Taka Only',
